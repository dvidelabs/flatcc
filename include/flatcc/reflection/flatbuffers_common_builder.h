...
#define __flatbuffers_build_table_root(NS, N, FID)\
...
#define __flatbuffers_build_nested_table_root(NS, N, TN, FID)\
static inline int N ## _start_as_root(NS ## builder_t *B)\
...
#define __flatbuffers_build_nested_struct_root(NS, N, TN, A, FID)\
...
__flatbuffers_build_struct_root(NS, N, A, FID)
