...
/* Generated by flatcc 0.6.4 FlatBuffers schema compiler for C by dvide.com */
...
static inline int reflection_Type_verify_as_root_with_size(const void *buf, size_t bufsiz)
{
    return flatcc_verify_table_as_root_with_size(buf, bufsiz, reflection_Type_identifier, &reflection_Type_verify_table);
}
...
static inline int reflection_Type_verify_as_typed_root_with_size(const void *buf, size_t bufsiz)
{
    return flatcc_verify_table_as_root_with_size(buf, bufsiz, reflection_Type_type_identifier, &reflection_Type_verify_table);
}
...
static inline int reflection_Type_verify_as_root_with_identifier_and_size(const void *buf, size_t bufsiz, const char *fid)
{
    return flatcc_verify_table_as_root_with_size(buf, bufsiz, fid, &reflection_Type_verify_table);
}
...
static inline int reflection_Type_verify_as_root_with_type_hash_and_size(const void *buf, size_t bufsiz, flatbuffers_thash_t thash)
{
    return flatcc_verify_table_as_typed_root_with_size(buf, bufsiz, thash, &reflection_Type_verify_table);
}
...
static inline int reflection_KeyValue_verify_as_root_with_size(const void *buf, size_t bufsiz)
{
    return flatcc_verify_table_as_root_with_size(buf, bufsiz, reflection_KeyValue_identifier, &reflection_KeyValue_verify_table);
}
...
static inline int reflection_KeyValue_verify_as_typed_root_with_size(const void *buf, size_t bufsiz)
{
    return flatcc_verify_table_as_root_with_size(buf, bufsiz, reflection_KeyValue_type_identifier, &reflection_KeyValue_verify_table);
}
...
static inline int reflection_KeyValue_verify_as_root_with_identifier_and_size(const void *buf, size_t bufsiz, const char *fid)
{
    return flatcc_verify_table_as_root_with_size(buf, bufsiz, fid, &reflection_KeyValue_verify_table);
}
...
static inline int reflection_KeyValue_verify_as_root_with_type_hash_and_size(const void *buf, size_t bufsiz, flatbuffers_thash_t thash)
{
    return flatcc_verify_table_as_typed_root_with_size(buf, bufsiz, thash, &reflection_KeyValue_verify_table);
}
...
static inline int reflection_EnumVal_verify_as_root_with_size(const void *buf, size_t bufsiz)
{
    return flatcc_verify_table_as_root_with_size(buf, bufsiz, reflection_EnumVal_identifier, &reflection_EnumVal_verify_table);
}
...
static inline int reflection_EnumVal_verify_as_typed_root_with_size(const void *buf, size_t bufsiz)
{
    return flatcc_verify_table_as_root_with_size(buf, bufsiz, reflection_EnumVal_type_identifier, &reflection_EnumVal_verify_table);
}
...
static inline int reflection_EnumVal_verify_as_root_with_identifier_and_size(const void *buf, size_t bufsiz, const char *fid)
{
    return flatcc_verify_table_as_root_with_size(buf, bufsiz, fid, &reflection_EnumVal_verify_table);
}
...
static inline int reflection_EnumVal_verify_as_root_with_type_hash_and_size(const void *buf, size_t bufsiz, flatbuffers_thash_t thash)
{
    return flatcc_verify_table_as_typed_root_with_size(buf, bufsiz, thash, &reflection_EnumVal_verify_table);
}
...
static inline int reflection_Enum_verify_as_root_with_size(const void *buf, size_t bufsiz)
{
    return flatcc_verify_table_as_root_with_size(buf, bufsiz, reflection_Enum_identifier, &reflection_Enum_verify_table);
}
...
static inline int reflection_Enum_verify_as_typed_root_with_size(const void *buf, size_t bufsiz)
{
    return flatcc_verify_table_as_root_with_size(buf, bufsiz, reflection_Enum_type_identifier, &reflection_Enum_verify_table);
}
...
static inline int reflection_Enum_verify_as_root_with_identifier_and_size(const void *buf, size_t bufsiz, const char *fid)
{
    return flatcc_verify_table_as_root_with_size(buf, bufsiz, fid, &reflection_Enum_verify_table);
}
...
static inline int reflection_Enum_verify_as_root_with_type_hash_and_size(const void *buf, size_t bufsiz, flatbuffers_thash_t thash)
{
    return flatcc_verify_table_as_typed_root_with_size(buf, bufsiz, thash, &reflection_Enum_verify_table);
}
...
static inline int reflection_Field_verify_as_root_with_size(const void *buf, size_t bufsiz)
{
    return flatcc_verify_table_as_root_with_size(buf, bufsiz, reflection_Field_identifier, &reflection_Field_verify_table);
}
...
static inline int reflection_Field_verify_as_typed_root_with_size(const void *buf, size_t bufsiz)
{
    return flatcc_verify_table_as_root_with_size(buf, bufsiz, reflection_Field_type_identifier, &reflection_Field_verify_table);
}
...
static inline int reflection_Field_verify_as_root_with_identifier_and_size(const void *buf, size_t bufsiz, const char *fid)
{
    return flatcc_verify_table_as_root_with_size(buf, bufsiz, fid, &reflection_Field_verify_table);
}
...
static inline int reflection_Field_verify_as_root_with_type_hash_and_size(const void *buf, size_t bufsiz, flatbuffers_thash_t thash)
{
    return flatcc_verify_table_as_typed_root_with_size(buf, bufsiz, thash, &reflection_Field_verify_table);
}
...
static inline int reflection_Object_verify_as_root_with_size(const void *buf, size_t bufsiz)
{
    return flatcc_verify_table_as_root_with_size(buf, bufsiz, reflection_Object_identifier, &reflection_Object_verify_table);
}
...
static inline int reflection_Object_verify_as_typed_root_with_size(const void *buf, size_t bufsiz)
{
    return flatcc_verify_table_as_root_with_size(buf, bufsiz, reflection_Object_type_identifier, &reflection_Object_verify_table);
}
...
static inline int reflection_Object_verify_as_root_with_identifier_and_size(const void *buf, size_t bufsiz, const char *fid)
{
    return flatcc_verify_table_as_root_with_size(buf, bufsiz, fid, &reflection_Object_verify_table);
}
...
static inline int reflection_Object_verify_as_root_with_type_hash_and_size(const void *buf, size_t bufsiz, flatbuffers_thash_t thash)
{
    return flatcc_verify_table_as_typed_root_with_size(buf, bufsiz, thash, &reflection_Object_verify_table);
}
...
static inline int reflection_RPCCall_verify_as_root_with_size(const void *buf, size_t bufsiz)
{
    return flatcc_verify_table_as_root_with_size(buf, bufsiz, reflection_RPCCall_identifier, &reflection_RPCCall_verify_table);
}
...
static inline int reflection_RPCCall_verify_as_typed_root_with_size(const void *buf, size_t bufsiz)
{
    return flatcc_verify_table_as_root_with_size(buf, bufsiz, reflection_RPCCall_type_identifier, &reflection_RPCCall_verify_table);
}
...
static inline int reflection_RPCCall_verify_as_root_with_identifier_and_size(const void *buf, size_t bufsiz, const char *fid)
{
    return flatcc_verify_table_as_root_with_size(buf, bufsiz, fid, &reflection_RPCCall_verify_table);
}
...
static inline int reflection_RPCCall_verify_as_root_with_type_hash_and_size(const void *buf, size_t bufsiz, flatbuffers_thash_t thash)
{
    return flatcc_verify_table_as_typed_root_with_size(buf, bufsiz, thash, &reflection_RPCCall_verify_table);
}
...
static inline int reflection_Service_verify_as_root_with_size(const void *buf, size_t bufsiz)
{
    return flatcc_verify_table_as_root_with_size(buf, bufsiz, reflection_Service_identifier, &reflection_Service_verify_table);
}
...
static inline int reflection_Service_verify_as_typed_root_with_size(const void *buf, size_t bufsiz)
{
    return flatcc_verify_table_as_root_with_size(buf, bufsiz, reflection_Service_type_identifier, &reflection_Service_verify_table);
}
...
static inline int reflection_Service_verify_as_root_with_identifier_and_size(const void *buf, size_t bufsiz, const char *fid)
{
    return flatcc_verify_table_as_root_with_size(buf, bufsiz, fid, &reflection_Service_verify_table);
}
...
static inline int reflection_Service_verify_as_root_with_type_hash_and_size(const void *buf, size_t bufsiz, flatbuffers_thash_t thash)
{
    return flatcc_verify_table_as_typed_root_with_size(buf, bufsiz, thash, &reflection_Service_verify_table);
}
...
static inline int reflection_Schema_verify_as_root_with_size(const void *buf, size_t bufsiz)
{
    return flatcc_verify_table_as_root_with_size(buf, bufsiz, reflection_Schema_identifier, &reflection_Schema_verify_table);
}
...
static inline int reflection_Schema_verify_as_typed_root_with_size(const void *buf, size_t bufsiz)
{
    return flatcc_verify_table_as_root_with_size(buf, bufsiz, reflection_Schema_type_identifier, &reflection_Schema_verify_table);
}
...
static inline int reflection_Schema_verify_as_root_with_identifier_and_size(const void *buf, size_t bufsiz, const char *fid)
{
    return flatcc_verify_table_as_root_with_size(buf, bufsiz, fid, &reflection_Schema_verify_table);
}
...
static inline int reflection_Schema_verify_as_root_with_type_hash_and_size(const void *buf, size_t bufsiz, flatbuffers_thash_t thash)
{
    return flatcc_verify_table_as_typed_root_with_size(buf, bufsiz, thash, &reflection_Schema_verify_table);
}
